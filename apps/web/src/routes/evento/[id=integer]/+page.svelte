<script lang="ts">
	...
	import ShareSocialMedia from './components/share-social-media.svelte';
...
<article class="flex flex-col gap-5 lg:flex-row">
	<div class="top-3 flex flex-1 flex-col gap-8 self-start overflow-auto lg:sticky">
		...
		<div class="hidden flex-col gap-6 lg:flex">
			<ShareSocialMedia urlToShare={$page.url.href} />
			<p class="text-lg">
	...
	<ShareSocialMedia className="lg:hidden justify-between" urlToShare={$page.url.href} />
</article>
